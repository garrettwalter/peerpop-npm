...
var defaultStyles = "\n  .peerpop-event-button { background-color: #000; color: #fff; padding: 10px 20px; border-radius: 5px; border: none; cursor: pointer; }\n  .peerpop-modal-overlay { position: fixed; inset: 0; background: rgb(37, 37, 37); display: flex; align-items: center; justify-content: center; z-index: 9999; }\n  .peerpop-modal-content { background: rgba(0,0,0,0.85); border-radius: 8px; width: 85vw; height: 85vh; max-width: 85vw; max-height: 85vh; overflow: hidden; display: flex; flex-direction: column; position: relative; }\n  .peerpop-modal-content iframe { border: none; width: 100%; height: 100%; min-height: 0; }\n  @media (max-width: 768px) { .peerpop-modal-content { width: 100vw; height: 100vh; max-width: none; max-height: none; border-radius: 0; } .peerpop-modal-content iframe { min-height: 100%; } }\n  .peerpop-modal-close { position: absolute; top: 0; right: 0; min-width: 48px; min-height: 48px; padding: 12px; display: flex; align-items: center; justify-content: center; background: rgba(0,0,0,0.5); border: none; font-size: 24px; cursor: pointer; line-height: 1; color: #fff; z-index: 10; -webkit-tap-highlight-color: transparent; }\n  .peerpop-modal-close:hover { color: #fff; background: rgba(0,0,0,0.7); }\n";
